...
/**
 * View class for a list of Ccgslider.
 */
class CcgsliderViewSliders extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        CcgsliderHelper::addSubmenu('sliders');
    ...
    protected function addToolbar() {
        ...
        $canDo = CcgsliderHelper::getActions($state->get('filter.category_id'));

        JToolBarHelper::title(JText::_('COM_CCGSLIDER_TITLE_SLIDERS'), 'sliders.png');
        ...
        if ($canDo->get('core.admin')) {
            JToolBarHelper::preferences('com_ccgslider');
        }

        //Set sidebar action - New in 3.0
        JHtmlSidebar::setAction('index.php?option=com_ccgslider&view=sliders');
	...
	protected function getSortFields()
	{
		...
		'a.title' => JText::_('COM_CCGSLIDER_SLIDERS_TITLE'),
		);
	}
