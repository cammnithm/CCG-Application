...
<html>
    ...
    <body style="background-color: #ffffff; font-family: Arial, Verdana, Sans-Serif;">
        ...
        <script src="JssorSlider/js/jquery-1.9.1.min.js" type="text/javascript"></script>
        <!-- jssor.slider.mini.js = (jssor.js + jssor.slider.js) -->
        <script src="JssorSlider/js/jssor.js" type="text/javascript"></script>
        <script src="JssorSlider/js/jssor.slider.min.js" type="text/javascript"></script>
        <script>
        ...
        <div id="slider1_container" style="position: relative; width: 600px;
            ...
            <div u="loading" style="position: absolute; top: 0px; left: 0px;">
                ...
                <div style="position: absolute; display: block; background: url('JssorSlider/img/loading.gif') no-repeat center center;
